...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [367],
  {
    27274: (e, n, t) => {
      ...
      class L {
        ...
        fromScene(e, n = 0, t = 0.1, r = 100) {
          ...
          return (
            (i.depthBuffer = !0),
            this._sceneToCubeUV(e, t, r, i),
            n > 0 && this._blur(i, 0, 0, n),
            this._applyPMREM(i),
            this._cleanup(i),
            i
          );
        ...
        _sceneToCubeUV(e, n, t, i) {
          let a = new r.ubm(90, 1, n, t),
            o = [1, -1, 1, 1, 1, 1],
            l = [1, 1, 1, -1, -1, -1],
            s = this._renderer,
            c = s.autoClear,
            d = s.toneMapping;
          s.getClearColor(S), (s.toneMapping = r.y_p), (s.autoClear = !1);
          let u = new r.V9B({
        ...
        _halfBlur(e, n, t, i, a, o, l) {
          ...
          U(n, 3 * S * (i > v - 4 ? i - v + 4 : 0), T, 3 * S, 2 * S),
            s.setRenderTarget(n),
            s.render(d, E);
        }
      }
	...
	`;
      ...
      function Z(e, n, t) {
        ...
        let i = n * t,
          a = K[i];
        if (
          (void 0 === a && ((a = new Float32Array(i)), (K[i] = a)), 0 !== n)
        ) {
          r.toArray(a, 0);
      ...
      function ee(e, n) {
        let t = q[n];
        void 0 === t && ((t = new Int32Array(n)), (q[n] = t));
      ...
      function ea(e, n) {
        ...
        if (void 0 === r) {
          ...
          if ($(t, r)) return;
          Q.set(r), e.uniformMatrix2fv(this.addr, !1, Q), J(t, r);
        }
      }
      function eo(e, n) {
        let t = this.cache,
        ...
        if (void 0 === r) {
          ...
          if ($(t, r)) return;
          j.set(r), e.uniformMatrix3fv(this.addr, !1, j), J(t, r);
        }
      }
      function el(e, n) {
        let t = this.cache,
        ...
        if (void 0 === r) {
          ...
          if ($(t, r)) return;
          Y.set(r), e.uniformMatrix4fv(this.addr, !1, Y), J(t, r);
        }
      }
      function es(e, n) {
        let t = this.cache;
      ...
      function eg(e, n, t) {
        ...
        r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
          t.setTexture3D(n || z, i);
      }
      function ev(e, n, t) {
        let r = this.cache,
          i = t.allocateTextureUnit();
        r[0] !== i && (e.uniform1i(this.addr, i), (r[0] = i)),
          t.setTextureCube(n || X, i);
      }
      function eE(e, n, t) {
        let r = this.cache,
          i = t.allocateTextureUnit();
      ...
      function eN(e, n, t) {
        let r = this.cache,
          i = n.length,
          a = ee(t, i);
        $(r, a) || (e.uniform1iv(this.addr, a), J(r, a));
      ...
      function eO(e, n, t) {
        let r = this.cache,
          ...
          a = ee(t, i);
        $(r, a) || (e.uniform1iv(this.addr, a), J(r, a));
        for (let e = 0; e !== i; ++e) t.setTexture3D(n[e] || z, a[e]);
      }
      function eF(e, n, t) {
        let r = this.cache,
          i = n.length,
        ...
        t.isRawShaderMaterial
          ...
          : ((a = [
            ...
            (l = [
              ...
              (function (e, n) {
                let t = (function (e) {
                  r.ppV._getMatrix(eq, r.ppV.workingColorSpace, e);
                  let n = `mat3( ${eq.elements.map((e) => e.toFixed(4))} )`;
	...
	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );
              ...
              (function () {
                r.ppV.getLuminanceCoefficients(ej);
	...
	return dot( weights, rgb );
      ...
      function nn(e, n, t, i, a, o, l) {
        ...
        return {
          ...
          acquireProgram: function (n, t) {
            ...
            return void 0 === r && ((r = new e9(e, t, n, o)), f.push(r)), r;
          },
      ...
      function na() {
        ...
        return {
          ...
          sort: function (e, n) {
            t.length > 1 && t.sort(e || nr),
              r.length > 1 && r.sort(n || ni),
              i.length > 1 && i.sort(n || ni);
          },
        };
      }
      function no() {
        ...
        getTargetRaySpace() {
          return (
            null === this._targetRay &&
              ((this._targetRay = new r.YJl()),
              (this._targetRay.matrixAutoUpdate = !1),
              (this._targetRay.visible = !1),
              (this._targetRay.hasLinearVelocity = !1),
              (this._targetRay.linearVelocity = new r.Pq0()),
              (this._targetRay.hasAngularVelocity = !1),
              (this._targetRay.angularVelocity = new r.Pq0())),
            this._targetRay
          );
        }
        getGripSpace() {
          return (
            null === this._grip &&
              ((this._grip = new r.YJl()),
              (this._grip.matrixAutoUpdate = !1),
              (this._grip.visible = !1),
              (this._grip.hasLinearVelocity = !1),
              (this._grip.linearVelocity = new r.Pq0()),
              (this._grip.hasAngularVelocity = !1),
              (this._grip.angularVelocity = new r.Pq0())),
            this._grip
          );
        }
        dispatchEvent(e) {
        ...
        update(e, n, t) {
          ...
          if (e && "visible-blurred" !== n.session.visibilityState) {
            if (s && e.hand) {
              ...
              null !== l &&
                e.gripSpace &&
                null !== (i = n.getPose(e.gripSpace, t)) &&
            ...
            null !== o &&
              (null === (r = n.getPose(e.targetRaySpace, t)) &&
                null !== i &&
                (r = i),
              null !== r &&
            ...
            (this.setSession = async function (i) {
              if (null !== (a = i)) {
                if (
                  ...
                  (x = e.getPixelRatio()),
                  e.getSize(M),
                  void 0 !== a.enabledFeatures &&
                    a.enabledFeatures.includes("layers"))
                ) {
                  let t = null,
                    i = null,
                    l = null;
          ...
          (this.updateCamera = function (e) {
            ...
            2 === o.length
              ...
              e.isPerspectiveCamera &&
                ((e.fov =
                  2 * r.a55 * Math.atan(1 / e.projectionMatrix.elements[5])),
                (e.zoom = 1));
          }),
        ...
        return {
          ...
          refreshMaterialUniforms: function (e, a, o, l, s) {
            a.isMeshBasicMaterial
              ...
              ? (i(e, a), a.matcap && (e.matcap.value = a.matcap))
        ...
        constructor(e = {}) {
                ...
                h = (function (e, n, t, i, a) {
                  ...
                  let f = n.fog,
                    ...
                    m =
                      null === ec
                        ...
                        : r.Zr2,
                    h = (i.isMeshStandardMaterial ? v : u).get(i.envMap || p),
                    _ =
                      !0 === i.vertexColors &&
                      !!t.attributes.color &&
                  ...
                  if (
                    ...
                    y &&
                      ...
                      f && !0 === i.fog && x.refreshFogUniforms(O, f),
                      ...
                      ez.upload(eN, e1(C), O, d)),
                    i.isShaderMaterial &&
                      !0 === i.uniformsNeedUpdate &&
                      (ez.upload(eN, e1(C), O, d), (i.uniformsNeedUpdate = !1)),
                    i.isSpriteMaterial && N.setValue(eN, "center", a.center),
            ...
            if (e.layers.test(n.layers)) {
              if (e.isGroup) t = e.renderOrder;
                ...
                if (!e.frustumCulled || eA.intersectsSprite(e)) {
                  r && ew.setFromMatrixPosition(e.matrixWorld).applyMatrix4(eP);
                  let n = T.update(e),
                    i = e.material;
                  i.visible && en.push(e, n, i, t, ew.z, null);
                }
              } else if (
                ...
                } else i.visible && en.push(e, n, i, t, ew.z, null);
              }
            }
            let i = e.children;
          ...
          function e0(e, n, t) {
            ...
            let r = c.get(e),
              ...
              d = r.programs;
            (r.environment = e.isMeshStandardMaterial ? n.environment : null),
              (r.fog = n.fog),
              (r.envMap = (e.isMeshStandardMaterial ? v : u).get(
            ...
            return (
              ...
              r.needsLights &&
                ...
                (p.spotLightMatrix.value = i.state.spotLightMatrix),
                (p.spotLightMap.value = i.state.spotLightMap),
          ...
          eY.setAnimationLoop(function (e) {
            ...
            (this.render = function (e, n) {
              ...
              if ((et.setupLights(), n.isArrayCamera)) {
                ...
                i.length > 0 && eZ(r, i, e, n), ey && L.render(e), eQ(en, e, n);
              null !== ec &&
                0 === es &&
              ...
              if (
                ...
                try {
                  ...
                  n >= 0 &&
                    ...
                    t >= 0 &&
                    t <= e.height - i &&
                    eN.readPixels(n, t, r, i, D.convert(s), D.convert(c), a);
                } finally {
              ...
              if (
                ...
                if (n >= 0 && n <= e.width - i && t >= 0 && t <= e.height - a) {
                  ...
                  eN.bindBuffer(eN.PIXEL_PACK_BUFFER, e),
                    ...
                    eN.readPixels(n, t, i, a, D.convert(f), D.convert(p), 0);
